...
(function () {
  ...
  const RECIPES = {
    ...
    /* ── İleri düzey drill dersleri (u35, u38, u39, u43, u49, u52, u66, u104) ─
     * Bu derslerin sorularında Türkçe karşılık bulunmadığı için kartlar
     * türetilemiyordu; kalıpların çevirileri burada elle yazıldı.            */
    "c104_l3": [
      card("S + be able to + V1",
        "The commission is able to verify the records.",
        "Komisyon kayıtları doğrulayabiliyor.",
        "Yeterlilik → “-ebiliyor”. can'in zaman çekimi yapılabilen biçimidir.",
        ["be able to", "is able to", "are able to"]),
      card("S + have to + V1",
        "Researchers have to submit the data before the deadline.",
        "Araştırmacılar verileri süre dolmadan sunmak zorundadır.",
        "Dış zorunluluk → “-mak zorunda”. must iç zorunluluk bildirir.",
        ["have to", "has to", "had to"]),
      card("S + used to + V1",
        "The institute used to publish annual reports.",
        "Enstitü eskiden yıllık rapor yayımlardı.",
        "Geçmiş alışkanlık → “eskiden ... -irdi”.",
        ["used to"]),
      card("S + had better + V1",
        "You had better check the primary sources.",
        "Birincil kaynakları kontrol etsen iyi olur.",
        "Uyarı içeren güçlü tavsiye → “-sen iyi olur”.",
        ["had better"])
    ],

    "c58_l1": [
      card("Gerund (V-ing) — eylem ismi",
        "Analyzing the data requires patience.",
        "Verileri analiz etmek sabır gerektirir.",
        "Özne ya da nesne olan eylem ismi → “-mek / -ma”.",
        ["analyzing", "ing "]),
      card("Participle (V3 / V-ing) — sıfat",
        "The data analyzed by the team was reliable.",
        "Ekibin analiz ettiği veriler güvenilirdi.",
        "İsmi niteleyen kısaltma → “-en / -dığı”. Yardımcı fiil düşer.",
        ["analyzed by", "written by", "published in"]),
      card("Infinitive (to + V1) — amaç",
        "They gathered data to test the hypothesis.",
        "Hipotezi sınamak için veri topladılar.",
        "Amaç mastarı → “-mek için”. Gerund ile karıştırılmamalıdır.",
        ["to test", "to obtain", "in order to"])
    ],

    "c60_l1_extra": [
      card("Noun + V3 (sıfat cümleciği kısaltması)",
        "The reports submitted last week are missing.",
        "Geçen hafta sunulan raporlar kayıp.",
        "“which were” düşer → edilgen kısaltma “-lan / -en” ile çevrilir.",
        ["submitted", "published", "obtained"]),
      card("V3 ..., S + V + O (zarf cümleciği kısaltması)",
        "Written in 1923, the manuscript remains influential.",
        "1923'te yazılan el yazması etkisini koruyor.",
        "Başta duran V3 öbeği ana cümlenin öznesini niteler.",
        ["written in", "founded in", "based on"]),
      card("V-ing (eden) ↔ V3 (etkilenen)",
        "The confusing results confused the whole team.",
        "Kafa karıştırıcı sonuçlar bütün ekibi şaşırttı.",
        "-ing eylemi yapanı (“karıştırıcı”), -ed etkileneni (“şaşırmış”) anlatır.",
        ["confusing", "interesting", "surprising"])
    ],

    "c38_l1": [
      card("Rarely / Seldom + Auxiliary + Subject + V1",
        "Rarely does the committee reject a proposal.",
        "Komisyon nadiren bir öneriyi reddeder.",
        "Olumsuz zarf başa gelince yardımcı fiil öne geçer; Türkçede söz dizimi değişmez.",
        ["rarely", "seldom", "never"]),
      card("Not only + Auxiliary + S + V, but also ...",
        "Not only did they publish the data, but they also shared the code.",
        "Yalnızca veriyi yayımlamakla kalmadılar, kodu da paylaştılar.",
        "“yalnızca ... -makla kalmadı, ... da” kalıbı.",
        ["not only"]),
      card("No sooner + had + S + V3 + than ...",
        "No sooner had the session ended than the results leaked.",
        "Oturum biter bitmez sonuçlar sızdı.",
        "Devrik zaman kalıbı → “-ar -maz”.",
        ["no sooner"])
    ],

    "c38_l2": [
      card("Only after + Clause + Auxiliary + S + V",
        "Only after the audit ended did the board approve the budget.",
        "Ancak denetim bittikten sonra kurul bütçeyi onayladı.",
        "Başa gelen “only” öbeği ana cümleyi devrik yapar; yan cümle düz kalır.",
        ["only after", "only when", "only then"]),
      card("Not until + Clause + Auxiliary + S + V",
        "Not until 2020 did the archive open to the public.",
        "Arşiv ancak 2020'de halka açıldı.",
        "“not until” → “ancak ... -de”. Türkçede olumsuzluk yükleme geçmez.",
        ["not until"]),
      card("Only if + Clause + Auxiliary + S + V",
        "Only if the data is verified will the report be published.",
        "Rapor ancak veriler doğrulanırsa yayımlanacak.",
        "Koşul öbeği başa gelince ana cümle devrilir → “ancak ... -sa”.",
        ["only if"])
    ],

    "c51_l3": [
      card("Hardly / Scarcely + had + S + V3 + when ...",
        "Hardly had the probe landed when the signals stopped.",
        "Sonda iner inmez sinyaller kesildi.",
        "hardly → when, no sooner → than eşleşmesi sabittir.",
        ["hardly", "scarcely", "barely"]),
      card("Under no circumstances + Auxiliary + S + V",
        "Under no circumstances should the files be copied.",
        "Dosyalar hiçbir koşulda kopyalanmamalıdır.",
        "Olumsuz edat öbeği başa gelir, modal özneden önce durur.",
        ["under no circumstances", "at no time", "in no way"]),
      card("Little did + Subject + V1",
        "Little did the researchers know that the sample was contaminated.",
        "Araştırmacılar örneğin kirlendiğini hiç bilmiyordu.",
        "“little did” kalıbı → “hiç ... -miyordu”.",
        ["little did"])
    ],

    "c40_l2_merged": [
      card("Edat + Noun / V-ing (isim alanlar)",
        "Despite the delay, the report was published.",
        "Gecikmeye rağmen rapor yayımlandı.",
        "despite / due to / in spite of isim ya da -ing alır, cümle almaz.",
        ["despite", "in spite of", "due to", "because of"]),
      card("Bağlaç + S + V + O (cümle alanlar)",
        "Although the delay continued, the report was published.",
        "Gecikme sürmesine rağmen rapor yayımlandı.",
        "although / because / while tam cümle alır → “-mesine rağmen”.",
        ["although", "even though", "because ", "while"]),
      card("SVO; however / therefore, SVO (cümle bağlayıcılar)",
        "The delay continued; however, the report was published.",
        "Gecikme sürdü; ancak rapor yayımlandı.",
        "Geçiş sözcüğü iki bağımsız cümleyi bağlar: “; however,” → “; ancak,”.",
        ["however", "therefore", "moreover", "nevertheless"])
    ],

    "c42_l1": [
      card("is likely to + V1",
        "The reform is likely to increase administrative costs.",
        "Reformun idari maliyetleri artırması muhtemeldir.",
        "Özne Türkçede tamlayana döner: “... -mesi muhtemeldir”.",
        ["likely to"]),
      card("is bound to be + V3",
        "The proposal is bound to be rejected.",
        "Önerinin reddedilmesi kaçınılmazdır.",
        "bound to kaçınılmazlık bildirir; edilgen mastar “-mesi” ile çevrilir.",
        ["bound to"]),
      card("is supposed to have + V3",
        "The committee is supposed to have finalized the report.",
        "Kurulun raporu tamamlamış olması gerekiyordu.",
        "“have V3” geçmişe bakar → “-mış olması”. Beklenti karşılanmamıştır.",
        ["supposed to have", "supposed to"])
    ],

    "c51_l1": [
      card("as (= because / while / like / as if)",
        "As the data was incomplete, the test was repeated.",
        "Veriler eksik olduğu için test tekrarlandı.",
        "as'in anlamı bağlamdan çıkar: sebep “-dığı için”, zaman “-ken”.",
        [" as "]),
      card("be about to + V1",
        "The system is about to restart.",
        "Sistem yeniden başlamak üzere.",
        "Çok yakın gelecek → “-mek üzere”.",
        ["about to"]),
      card("be on the verge of + Noun / V-ing",
        "The firm is on the verge of collapsing.",
        "Firma çökmenin eşiğinde.",
        "“... eşiğinde”; of'tan sonra isim ya da -ing gelir.",
        ["on the verge of", "on the brink of"])
    ],

    "c52_l3": [
      card("lest + Subject + V1 (yalın)",
        "They archived the files lest the data be lost.",
        "Veriler kaybolmasın diye dosyaları arşivlediler.",
        "lest → “-mesin diye”; ardından gelen fiil yalın kalır (subjunctive).",
        ["lest"]),
      card("SVO. Otherwise, SVO",
        "Back up the archive. Otherwise, the records will be lost.",
        "Arşivi yedekle. Aksi takdirde kayıtlar kaybolur.",
        "otherwise gizli bir şart taşır → “aksi takdirde”.",
        ["otherwise"]),
      card("It is thought that ... ➔ S + is thought to + V1",
        "The manuscript is thought to be genuine.",
        "El yazmasının gerçek olduğu düşünülüyor.",
        "Söylenti yapısında that-cümlesinin öznesi öne taşınır → “-dığı düşünülüyor”.",
        ["is thought to", "is believed to", "it is thought"])
    ],

    "c43_l1": [
      card("is likely to be + V3",
        "The findings are likely to be verified next term.",
        "Bulguların gelecek dönem doğrulanması muhtemeldir.",
        "Edilgen mastar → “-mesi”; olasılık yükleme taşınır.",
        ["likely to be"]),
      card("is bound to be + V3",
        "The claim is bound to be challenged.",
        "İddianın sorgulanması kaçınılmazdır.",
        "bound to → “kaçınılmaz”; edilgenlik Türkçede “-il/-in” ekiyle verilir.",
        ["bound to be"]),
      card("is supposed to be + V3",
        "The data is supposed to be archived weekly.",
        "Verilerin haftalık olarak arşivlenmesi gerekiyor.",
        "Kural/beklenti → “-mesi gerekiyor”.",
        ["supposed to be"])
    ],

    "c47_l1": [
      card("modal + have been + V-ing",
        "The team must have been working overnight.",
        "Ekip gece boyunca çalışıyor olmalı.",
        "Zinciri sondan başa çöz: working → have been → must → “çalışıyor olmalı”.",
        ["have been working", "must have been"]),
      card("modal + have been + V3",
        "The files must have been deleted during the migration.",
        "Dosyalar geçiş sırasında silinmiş olmalı.",
        "Geçmişe dönük çıkarım + edilgen → “-mış olmalı”.",
        ["have been deleted", "must have been"]),
      card("be expected to have been + V3",
        "The report is expected to have been submitted.",
        "Raporun sunulmuş olması bekleniyor.",
        "Beklenti + tamamlanmışlık → “-mış olması bekleniyor”.",
        ["expected to have been"])
    ],

    "c44_l1": [
      card("is rumored to have been + V3",
        "The site is rumored to have been looted.",
        "Alanın yağmalanmış olduğu söyleniyor.",
        "Söylenti + geçmiş edilgen → “-mış olduğu söyleniyor”.",
        ["rumored to have been"]),
      card("is likely to have been + V3",
        "The tablet is likely to have been carved in 600 BC.",
        "Tabletin MÖ 600'de oyulmuş olması muhtemeldir.",
        "Olasılık geçmişe bakıyor → “-mış olması muhtemeldir”.",
        ["likely to have been"]),
      card("is supposed to have been + V3",
        "The archive is supposed to have been digitised.",
        "Arşivin dijitalleştirilmiş olması gerekiyordu.",
        "Gerçekleşmemiş beklenti → “-mış olması gerekiyordu”.",
        ["supposed to have been"])
    ],

    "c45_l1": [
      card("is rumored to have been being + V3",
        "The manuscript is rumored to have been being restored for years.",
        "El yazmasının yıllardır restore edilmekte olduğu söyleniyor.",
        "“have been being V3” süregelen edilgen → “-mekte olduğu”.",
        ["to have been being", "rumored to"]),
      card("is supposed to have been being + V3",
        "The chamber is supposed to have been being monitored since 2010.",
        "Odanın 2010'dan beri izlenmekte olduğu varsayılıyor.",
        "Söylenti öznesi öne alınır; süreklilik “-mekte” ile korunur.",
        ["supposed to have been being"])
    ],

    "c45_l2": [
      card("was rumored to have been being + V3",
        "The site was rumored to have been being excavated in secret.",
        "Alanın gizlice kazılmakta olduğu söyleniyordu.",
        "Ana fiil geçmişteyse söylenti de geçmişe kayar → “söyleniyordu”.",
        ["was rumored", "were rumored"]),
      card("was supposed to have been being + V3",
        "The frescoes were supposed to have been being cleaned that season.",
        "Fresklerin o sezon temizlenmekte olması gerekiyordu.",
        "Geçmişte karşılanmamış beklenti → “-mekte olması gerekiyordu”.",
        ["was supposed to have been", "were supposed to have been"])
    ],

    "c46_l1": [
      card("must have been supposed to have been + V3",
        "The samples must have been supposed to have been sealed.",
        "Örneklerin mühürlenmiş olması gerekiyor olmalıydı.",
        "Zincir sondan başa çözülür: sealed → have been → supposed → must.",
        ["must have been supposed"]),
      card("should have been bound to have been + V3",
        "The report should have been bound to have been reviewed.",
        "Raporun incelenmiş olmasının kaçınılmaz olması gerekirdi.",
        "İki katmanlı kip: önce kaçınılmazlık, sonra “-meliydi” eklenir.",
        ["should have been bound"])
    ],

    "c49_l1": [
      card("is / are rumored to have been + V3",
        "The coins are rumored to have been struck in a private mint.",
        "Sikkelerin özel bir darphanede basılmış olduğu söyleniyor.",
        "“-mış olduğu söyleniyor”. Özne Türkçede tamlayan olur.",
        ["rumored to have been"]),
      card("is / are believed to have been + V3",
        "The temple is believed to have been built in 300 BC.",
        "Tapınağın MÖ 300'de inşa edildiğine inanılıyor.",
        "believe → “inanılıyor”; tarih verilmişse “-dığı” yeterlidir.",
        ["believed to have been"]),
      card("was / were supposed to have been + V3",
        "The frescoes were supposed to have been restored last year.",
        "Fresklerin geçen yıl restore edilmiş olması gerekiyordu.",
        "Geçmişte karşılanmamış beklenti → “-mış olması gerekiyordu”.",
        ["supposed to have been"])
    ],

    "c49_l3": [
      card("could / might have been expected to have been + V3",
        "The delay could have been expected to have been reported.",
        "Gecikmenin bildirilmiş olması beklenebilirdi.",
        "Olasılık + beklenti zinciri → “-mış olması beklenebilirdi”.",
        ["have been expected to have been"]),
      card("ought to have been + V3",
        "The findings ought to have been published earlier.",
        "Bulguların daha erken yayımlanmış olması gerekirdi.",
        "ought to have V3 → gerçekleşmemiş gereklilik: “-meliydi / gerekirdi”.",
        ["ought to have been"])
    ],

    "c50_l1": [
      card("modal + have been + V-ing",
        "The sensors might have been recording all night.",
        "Sensörler bütün gece kayıt yapıyor olabilir.",
        "Süregelen eylem üzerine çıkarım → “-yor olabilir”.",
        ["might have been", "could have been", "have been recording"]),
      card("modal + have been + V3",
        "The samples could have been contaminated.",
        "Örnekler kirlenmiş olabilir.",
        "Edilgen + çıkarım → “-mış olabilir”.",
        ["have been contaminated", "could have been"]),
      card("be expected / supposed to have been + V3",
        "The audit is expected to have been completed.",
        "Denetimin tamamlanmış olması bekleniyor.",
        "Beklenti yükleme, eylem tamlayana taşınır.",
        ["expected to have been", "supposed to have been"])
    ],

    /* ── Devrik cümleler ve koşul tipleri (u38, u39) ────────────────────── */
    "c38_l3": [
      card("Should + S + V1  (= If + S + V1)",
        "Should you require further evidence, the archive will be reopened.",
        "Daha fazla kanıta ihtiyaç duyarsanız arşiv yeniden açılacaktır.",
        "if düşer, should öne gelir. Türkçede yine sıradan koşul eki: “-irse / -arsanız”.",
        ["should you", "should the", "should they"]),
      card("Were + S + to + V1  (= If + S + V2)",
        "Were the commission to reject the appeal, the case would end.",
        "Komisyon itirazı reddedecek olsaydı dava sona ererdi.",
        "Type 2 devriği → “-ecek olsaydı ... -irdi”. Gerçek dışı bugünü anlatır.",
        ["were the", "were they", "were he", "were i"]),
      card("Had + S + V3  (= If + S + had + V3)",
        "Had they known the risk, they would have postponed the trial.",
        "Riski bilselerdi denemeyi ertelerlerdi.",
        "Type 3 devriği → “-seydi ... -irdi/-ecekti”. Geçmişte olmamış olayı anlatır.",
        ["had they", "had the", "had she", "had he"])
    ],

    "c38_l4": [
      card("..., and so + auxiliary + subject",
        "The historians agreed, and so did the economists.",
        "Tarihçiler katıldı, iktisatçılar da katıldı.",
        "Olumlu katılım → “... de/da” + aynı fiil. Yardımcı fiil özneden önce gelir.",
        ["and so did", "and so", "so did"]),
      card("..., nor / neither + auxiliary + subject",
        "The board did not object, nor did the committee.",
        "Kurul itiraz etmedi, komisyon da etmedi.",
        "Olumsuz katılım → “... da etmedi”. Türkçede ikinci kez olumsuzlanmaz.",
        ["nor did", "neither did", "nor has", "neither has"]),
      card("Adjective + though / as + Subject + Verb",
        "Complex though the model is, it predicts the trend accurately.",
        "Model karmaşık olsa da eğilimi doğru tahmin ediyor.",
        "Sıfat başa geçer → “... olsa da”. although'lu cümlenin vurgulu biçimidir.",
        ["though the", "though she", "though it", "as it is"])
    ],

    "c38_l5": [
      card("Yer öbeği + Fiil + Özne",
        "Under the tree sat an old man.",
        "Ağacın altında yaşlı bir adam oturuyordu.",
        "Yer öbeği başa gelince özne fiilin arkasına düşer; Türkçe sıra zaten böyledir.",
        ["under the", "beneath the", "on the wall", "in the corner"]),
      card("Yön öbeği + Fiil + Özne",
        "Into the room ran the boy.",
        "Çocuk koşarak odaya girdi.",
        "Yön öbeği vurguludur; Türkçede eylem sona alınır, vurgu yer adında kalır.",
        ["into the", "out of the", "down the", "across the"]),
      card("Past Participle öbeği + be + Özne",
        "Attached to the report were the original documents.",
        "Raporun ekinde özgün belgeler yer alıyordu.",
        "Edilgen sıfat öbeği başa gelir, özne sona düşer → “... yer alıyordu”.",
        ["attached to", "included in", "enclosed with"])
    ],

    "c40_l8_merged": [
      card("Hardly / Scarcely + had + S + V3 ... when + V2",
        "Hardly had the session started when the system crashed.",
        "Oturum başlar başlamaz sistem çöktü.",
        "hardly'nin eşi when'dir → “-ar -maz”.",
        ["hardly", "scarcely", "barely"]),
      card("No sooner + had + S + V3 ... than + V2",
        "No sooner had the report appeared than the market reacted.",
        "Rapor yayımlanır yayımlanmaz piyasa tepki verdi.",
        "no sooner'ın eşi than'dir; when ile kurulmaz.",
        ["no sooner"]),
      card("Seldom / Rarely / Not only + Auxiliary + S + V",
        "Rarely has the council overturned a decision of the technical board.",
        "Konsey, teknik kurulun bir kararını nadiren bozmuştur.",
        "Olumsuz zarf başa gelince yardımcı fiil öne geçer; Türkçede söz dizimi değişmez.",
        ["rarely", "seldom", "not only"])
    ],

    "c40_l3_merged": [
      card("Type 0: If + V1 ➔ V1",
        "If water reaches 100°C, it boils.",
        "Su 100 °C'ye ulaşırsa kaynar.",
        "Genel doğrular → “-irse ... -ir”. İki yakada da geniş zaman bulunur.",
        ["boils", "freezes", "melts"]),
      card("Type 1: If + V1 ➔ will + V1",
        "If the data is verified, the report will be published.",
        "Veriler doğrulanırsa rapor yayımlanacak.",
        "Gerçekleşebilir koşul → “-irse ... -ecek”. Yan cümlede will kullanılmaz.",
        ["will be published", "will publish", "if the data"]),
      card("Type 2: If + V2 ➔ would + V1",
        "If the budget were larger, the team would expand the survey.",
        "Bütçe daha büyük olsaydı ekip araştırmayı genişletirdi.",
        "Bugünün gerçek dışı koşulu → “-saydı ... -irdi”. were her öznede kullanılır.",
        ["would expand", "were larger", "if the budget"]),
      card("Type 3: If + had + V3 ➔ would have + V3",
        "If they had known the risk, they would have postponed the trial.",
        "Riski bilselerdi denemeyi ertelerlerdi.",
        "Geçmişin gerçek dışı koşulu → “-seydi ... -irdi/-ecekti”.",
        ["would have", "had known", "had verified"]),
      card("Mix: If + had + V3 ➔ would + V1 (bugün)",
        "If they had verified the data, the report would be ready now.",
        "Verileri doğrulamış olsalardı rapor şimdi hazır olurdu.",
        "Koşul geçmişte, sonuç bugündedir → “-mış olsalardı ... şimdi ... olurdu”.",
        ["would be ready", "now", "today"]),
      card("Devrik koşul: Had / Were / Should + S ...",
        "Had they verified the data, the report would be ready.",
        "Verileri doğrulamış olsalardı rapor hazır olurdu.",
        "if düşer, had/were/should öne gelir; Türkçe karşılık değişmez.",
        ["had they", "were they", "should they"])
    ],

    "c56_l7": [
      card("I wish + S + V2 / were  (şimdiki dilek)",
        "I wish the archive were open on Sundays.",
        "Keşke arşiv pazar günleri açık olsa.",
        "Bugüne dair dilek → “keşke ... -se”. V2 geçmişi değil, gerçek dışını gösterir.",
        ["wish the", "wish i", "wish they", "wishes"]),
      card("I wish + S + had + V3  (geçmiş pişmanlık)",
        "I wish they had verified the data before publishing.",
        "Keşke yayımlamadan önce verileri doğrulasalardı.",
        "Geçmişe pişmanlık → “keşke ... -saydı / -salardı”.",
        ["wish they had", "wish i had", "had verified"]),
      card("I wish + S + would + V1  (sitem)",
        "I wish the committee would answer our letters.",
        "Keşke komisyon mektuplarımıza cevap verse.",
        "Sitem/rahatsızlık: başkasının davranışının değişmesi istenir.",
        ["would answer", "wish the committee would", "wish you would"]),
      card("If only + Clause",
        "If only the funding had arrived earlier.",
        "Keşke fon daha erken gelseydi.",
        "if only, I wish'in vurgulu biçimidir; aynı zaman kuralları geçerlidir.",
        ["if only"])
    ],
    ...
    "c104_l1": [
      card("S + be able to + V1",
        "The commission was able to reform the monetary system.",
        "Komisyon parasal sistemi reforme etmeyi başardı.",
        "Geçmişte tek seferlik başarı → “-meyi başardı”; could bunu tam karşılamaz.",
        ["able to"]),
      card("S + have to / has to + V1",
        "Members have to approve the budget proposal.",
        "Üyeler bütçe teklifini onaylamak zorundadır.",
        "Dış zorunluluk → “-mak zorunda”. must kişinin kendi kararıdır.",
        ["have to", "has to"]),
      card("S + had to + V1",
        "They had to postpone the parliamentary hearing.",
        "Meclis oturumunu ertelemek zorunda kaldılar.",
        "must'ın geçmişi yoktur; zorunluluk geçmişte “had to” ile kurulur.",
        ["had to"]),
      card("S + needn't / don't have to + V1",
        "Members don't have to approve the proposal unless they reach a consensus.",
        "Üyeler uzlaşıya varmadıkça teklifi onaylamak zorunda değildir.",
        "Gereksizlik → “zorunda değil”. mustn't (yasak) ile karıştırılmamalıdır.",
        ["needn't", "need not", "don't have to", "does not have to", "doesn't have to"])
    ],

    "c104_l2": [
      card("S + ought to + V1",
        "The sociologists ought to analyze the behavior of individuals.",
        "Sosyologlar bireylerin davranışlarını analiz etmelidir.",
        "Güçlü öneri → “-meli”. should ile eş anlamlıdır, biraz daha resmîdir.",
        ["ought to"]),
      card("S + had better + V1",
        "The government had better implement the constitutional reform.",
        "Hükümet anayasal reformu uygulasa iyi olur.",
        "Uyarı taşır: yapılmazsa olumsuz sonuç var → “-sa iyi olur”.",
        ["had better"]),
      card("S + used to + V1",
        "Directors used to shoot films in the parliament.",
        "Yönetmenler eskiden parlamentoda film çekerdi.",
        "Geçmiş alışkanlık → “eskiden ... -irdi”. Ardından yalın fiil gelir.",
        ["used to"]),
      card("S + be / get used to + V-ing",
        "Therapists are used to evaluating emotional development.",
        "Terapistler duygusal gelişimi değerlendirmeye alışıktır.",
        "to'dan sonra V-ing gelir. be used to “alışık olmak”, get used to “alışmak”tır.",
        ["be used to", "get used to", "used to evaluating"])
    ]
  };
