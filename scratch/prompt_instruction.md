...
* **Uzun Cümleler İçin Dilbilgisel Bloklama (Word Bank - Kelime Sıralama):**
  - Kelime sıralama sorularında (word-bank) eğer İngilizce cümle uzun ise (8 kelime veya daha fazla), kelimeler tek tek bölünmek yerine anlamlı dilbilgisel öbekler (bloklar) halinde sunulmalıdır.
  - Gruplama esnasında; özne (subject), yüklem (predicate), nesne (object), edat ve zarf takımları gibi bütünsel dilbilgisi öğeleri beraberce gruplanmalı; öznenin veya diğer ana öğelerin bir kısmı bölünerek başka bir gruba dahil edilmemelidir.
  - Örnek: *"Severe data formatting issues give rise to validation anomalies"* cümlesi:
    - **[Severe data formatting issues]** (Özne Grubu)
    - **[give rise to]** (Yüklem Grubu)
    - **[validation anomalies]** (Nesne Grubu)
    şeklinde 3 bütünsel öbek olarak ayrılmalıdır. Öznenin bir kısmı bir grupta, diğeri başka bir grupta yüklemle beraber yer almamalıdır.
