      ...
      exercises: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              options: [
                "Geçmişteki spesifik bir başlangıç noktasını (Past Point) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ V2</span>",
                "Gelecekteki tahmini bir zaman sınırını (Future Deadline) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ V1 veya V2</span>",
                "Şu anda devam etmekte olan bir süreci (Ongoing Process) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ am/is/are + Ving</span>",
                "Geçmişteki eylemin öncesindeki başka bir geçmişi (Older Past) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ had + V3</span>"
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                "Geçmişteki o başlangıç noktasından günümüze (ŞİMDİ) kadar olan süreci <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ have/has + V3</span>",
                "Gelecekte eylemin biteceği son sınıra kadar olan süreci <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ will have + V3</span>",
                "Sadece geçmişte başlayıp biten anlık eylemleri <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ V2</span>",
                "Gelecekteki tekrarlanacak alışkanlıkları <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ will + V1</span>"
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                "Bir eylemin diğerinden önce tamamlandığı son sınırı (Deadline / Limit) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ By the time + V1 veya V2</span>",
                "İki eylemin aynı anda paralel olarak devam ettiğini <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ While + was/were Ving</span>",
                "Eylemin geçmişte başlayıp günümüzde hala sürdüğünü <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ Since + V2 ... have/has V3</span>",
                "Gelecekte yapılma ihtimali olan varsayımsal bir eylemi <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ If + V1 ... will + V1</span>"
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                "Bu geçmiş sınırdan da önce tamamlanmış olan eylemi (Older Past) <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ had + V3</span>",
                "Gelecekte bu sınırdan sonra başlayacak olan eylemi <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ will + V1</span>",
                "Şu anda devam etmekte olan güncel durumu <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ am/is/are + Ving</span>",
                "Geçmişte başlayıp hala devam eden süreci <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ have/has + been + Ving</span>"
              ],
              correctIndex: 0,
            ...
            },
            {
              ...
              options: [
                "Gelecekteki o sınırdan önce tamamlanmış olacak süreci <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ will have + V3</span>",
                "Geçmişte çoktan tamamlanmış olan süreci <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ had + V3</span>",
                "Şu an tam gerçekleşmekte olan eylemi <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ am/is/are + Ving</span>",
                "Gelecekteki o sınırdan sonra başlayacak olan ani durumu <span style='color: var(--color-info, #3b82f6); font-weight: 600; margin-left: 4px;'>/ will + V1</span>"
              ],
              correctIndex: 0,
