const wordDictionary = {
  ...
  "clarify": "açıklığa kavuşturmak / netleştirmek",
  ...
  "specifies": "belirler",
  "specify": "belirlemek / açıkça belirtmek",
  ...
  "strong": "güçlü",
  "strongly": "şiddetle / güçlü bir şekilde",
  "structural": "yapısal",
  ...
  "tensions": "gerilimler",
  "terminate": "sonlandırmak / feshetmek",
  "terminated": "feshetti",
  "test": "test / deneme",
...
const unitAra2Lesson2SentencesRaw = [
...
const unitAra2Lesson3SentencesRaw = [
...
const unitAra2Lesson4SentencesRaw = [
...
const unitAra1Lesson1SentencesRaw = [
...
const unitAra1Lesson2SentencesRaw = [
...
const unitAra1Lesson3SentencesRaw = [
...
const unitAra1Lesson4SentencesRaw = [
...
const unit18Lesson1SentencesRaw = [
...
const unit18Lesson2SentencesRaw = [
...
const unit18Lesson3SentencesRaw = [
...
const unit18LessonSentences = {
  1: unit18Lesson1SentencesRaw,
  2: unit18Lesson2SentencesRaw,
  3: unit18Lesson3SentencesRaw
};
...
const rawTopics = [
  ...
  },
  {
    ...
    formulas: [
      { 
        formula: "Wh- Word + Infinitive (to V)", 
        example: "They do not know how to solve the problem: Sorunu nasıl çözeceklerini bilmiyorlar",
        description: "Tercüme Kılavuzu: Soru kelimelerinden (how, what, where, when, whether, which, whom) sonra gelen mastar öbekleri, fiilin gelecek zaman anlamını ('yapacağını', 'yapılacağını') taşır. Cümleler genellikle özne ve geçişli bir fiil ile başlayıp bu öbeği nesne olarak alır. Çeviri yaparken önce cümlenin başına (özneye) bakılır, ardından Wh- kelimesine bağlı mastar grubunun nesnesi ve fiili Türkçeye uygun gelecek zaman ekleriyle çevrilerek ana yükleme bağlanır."
      }
    ],
    subtitles: [
      "A. Soru Kelimesinden Sonra Gelen Mastar — Temel Giriş Yapıları (Sayfa 124)",
      "B. Soru Kelimesinden Sonra Gelen Mastar — Günlük Dil ve Cümle Yapıları (Sayfa 125)",
...
const unitSentencesMap = {
  ...
  14: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit13LessonSentences[1], 14, 45, 1, 0),
      buildCustom10QuestionExercises(unit13LessonSentences[1], 14, 45, 2, 10),
      buildCustom10QuestionExercises(unit13LessonSentences[1], 14, 45, 3, 20),
      buildCustom10QuestionExercises(unit13LessonSentences[1], 14, 45, 4, 30)
    ] },
    2: { exercises: [
      buildAcademicExercises(unit13LessonSentences[2], 14, 46, 1, 0),
      buildAcademicExercises(unit13LessonSentences[2], 14, 46, 2, 10),
      buildAcademicExercises(unit13LessonSentences[2], 14, 46, 3, 5),
      buildAcademicExercises(unit13LessonSentences[2], 14, 46, 4, 12)
    ] }
  },
  15: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit14LessonSentences[1], 15, 47, 1, 0),
      buildCustom10QuestionExercises(unit14LessonSentences[1], 15, 47, 2, 10),
      buildCustom10QuestionExercises(unit14LessonSentences[1], 15, 47, 3, 20),
      buildAcademicExercises(unit14AcademicSentencesRaw, 15, 47, 4, 0),
      buildAcademicExercises(unit14AcademicSentencesRaw, 15, 47, 5, 10),
      buildAcademicExercises(unit14AcademicSentencesRaw, 15, 47, 6, 5)
    ] }
  },
  16: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit15Lesson1SentencesRaw, 16, 48, 1, 0),
      buildCustom10QuestionExercises(unit15Lesson1SentencesRaw, 16, 48, 2, 10),
      buildCustom10QuestionExercises(unit15Lesson1SentencesRaw, 16, 48, 3, 20)
    ] },
    2: { exercises: [
      buildCustom10QuestionExercises(unit15Lesson2SentencesRaw, 16, 49, 1, 0),
      buildCustom10QuestionExercises(unit15Lesson2SentencesRaw, 16, 49, 2, 10),
      buildCustom10QuestionExercises(unit15Lesson2SentencesRaw, 16, 49, 3, 20)
    ] },
    3: { exercises: [
      buildCustom10QuestionExercises(unit15Lesson3SentencesRaw, 16, 50, 1, 0),
      buildCustom10QuestionExercises(unit15Lesson3SentencesRaw, 16, 50, 2, 10),
      buildCustom10QuestionExercises(unit15Lesson3SentencesRaw, 16, 50, 3, 20)
    ] }
  },
  17: {
    1: { exercises: [
  ...
  18: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit16LessonSentences[1], 18, 47, 1, 0),
      buildCustom10QuestionExercises(unit16LessonSentences[1], 18, 47, 2, 10),
      buildCustom10QuestionExercises(unit16LessonSentences[1], 18, 47, 3, 20),
      buildCustom10QuestionExercises(unit16LessonSentences[1], 18, 47, 4, 30),
      buildCustom10QuestionExercises(unit16LessonSentences[1], 18, 47, 5, 40)
    ] }
  },
  19: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit17Lesson1SentencesRaw, 19, 48, 1, 0),
      buildCustom10QuestionExercises(unit17Lesson1SentencesRaw, 19, 48, 2, 10),
      buildCustom10QuestionExercises(unit17Lesson1SentencesRaw, 19, 48, 3, 20),
      buildCustom10QuestionExercises(unit17Lesson1SentencesRaw, 19, 48, 4, 30)
    ] },
    2: { exercises: [
      buildCustom10QuestionExercises(unit17Lesson2SentencesRaw, 19, 49, 1, 0),
      buildCustom10QuestionExercises(unit17Lesson2SentencesRaw, 19, 49, 2, 10),
      buildCustom10QuestionExercises(unit17Lesson2SentencesRaw, 19, 49, 3, 20),
      buildCustom10QuestionExercises(unit17Lesson2SentencesRaw, 19, 49, 4, 30)
    ] },
    3: { exercises: [
      buildCustom10QuestionExercises(unit17Lesson3SentencesRaw, 19, 50, 1, 0),
      buildCustom10QuestionExercises(unit17Lesson3SentencesRaw, 19, 50, 2, 10),
      buildCustom10QuestionExercises(unit17Lesson3SentencesRaw, 19, 50, 3, 20),
      buildCustom10QuestionExercises(unit17Lesson3SentencesRaw, 19, 50, 4, 30)
    ] }
  },
  20: {
    1: { exercises: [
      buildCustom10QuestionExercises(unit18Lesson1SentencesRaw, 20, 51, 1, 0),
      buildCustom10QuestionExercises(unit18Lesson1SentencesRaw, 20, 51, 2, 10),
      buildCustom10QuestionExercises(unit18Lesson1SentencesRaw, 20, 51, 3, 20),
      buildCustom10QuestionExercises(unit18Lesson1SentencesRaw, 20, 51, 4, 30)
    ] },
    2: { exercises: [
      buildCustom10QuestionExercises(unit18Lesson2SentencesRaw, 20, 52, 1, 0),
      buildCustom10QuestionExercises(unit18Lesson2SentencesRaw, 20, 52, 2, 10),
      buildCustom10QuestionExercises(unit18Lesson2SentencesRaw, 20, 52, 3, 20),
      buildCustom10QuestionExercises(unit18Lesson2SentencesRaw, 20, 52, 4, 30)
    ] },
    3: { exercises: [
      buildCustom10QuestionExercises(unit18Lesson3SentencesRaw, 20, 53, 1, 0),
      buildCustom10QuestionExercises(unit18Lesson3SentencesRaw, 20, 53, 2, 10),
      buildCustom10QuestionExercises(unit18Lesson3SentencesRaw, 20, 53, 3, 20),
      buildCustom10QuestionExercises(unit18Lesson3SentencesRaw, 20, 53, 4, 30)
    ] }
  },
  21: {
    1: { exercises: [] },
