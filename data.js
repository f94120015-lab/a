...
const unit12LessonSentences = {
  1: [
    { en: "The students working in the laboratory", tr: "Laboratuvarda çalışan öğrenciler", word: "working", trWord: "çalışan", blank: "The students ___ in the laboratory" },
    { en: "The specialist treating the disease in the clinic", tr: "Klinikte hastalığı tedavi eden uzman", word: "treating", trWord: "tedavi eden", blank: "The specialist ___ the disease in the clinic" },
    { en: "The plants growing in the garden", tr: "Bahçede büyüyen bitkiler", word: "growing", trWord: "büyüyen", blank: "The plants ___ in the garden" },
    { en: "The machine operating in the factory", tr: "Fabrikada çalışan makine", word: "operating", trWord: "çalışan", blank: "The machine ___ in the factory" },
    { en: "The virus spreading in the community", tr: "Toplulukta yayılan virüs", word: "spreading", trWord: "yayılan", blank: "The virus ___ in the community" },
    { en: "The authors writing the articles", tr: "Makaleleri yazan yazarlar", word: "writing", trWord: "yazan", blank: "The authors ___ the articles" },
    { en: "The device consuming the energy", tr: "Enerjiyi tüketen cihaz", word: "consuming", trWord: "tüketen", blank: "The device ___ the energy" },
    { en: "The project expanding the market", tr: "Pazarı genişleten proje", word: "expanding", trWord: "genişleten", blank: "The project ___ the market" }
  ],
  2: [
    { en: "Factors limiting the growth", tr: "Büyümeyi sınırlayan faktörler", word: "limiting", trWord: "sınırlayan", blank: "Factors ___ the growth" },
    { en: "Policies affecting the market", tr: "Pazarı etkileyen politikalar", word: "affecting", trWord: "etkileyen", blank: "Policies ___ the market" },
    { en: "Software processing the data", tr: "Verileri işleyen yazılım", word: "processing", trWord: "işleyen", blank: "Software ___ the data" },
    { en: "Laws protecting the environment", tr: "Çevreyi koruyan yasalar", word: "protecting", trWord: "koruyan", blank: "Laws ___ the environment" },
    { en: "Force supporting the regime", tr: "Rejimi destekleyen güç", word: "supporting", trWord: "destekleyen", blank: "Force ___ the regime" },
    { en: "Plans stimulating the economy", tr: "Ekonomiyi canlandıran planlar", word: "stimulating", trWord: "canlandıran", blank: "Plans ___ the economy" },
    { en: "Actions challenging the authority", tr: "Otoriteye meydan okuyan eylemler", word: "challenging", trWord: "meydan okuyan", blank: "Actions ___ the authority" },
    { en: "Methods simplifying the design", tr: "Tasarımı basitleştiren yöntemler", word: "simplifying", trWord: "basitleştiren", blank: "Methods ___ the design" }
  ],
  3: [
    { en: "The data obtained from the experiments", tr: "Deneylerden elde edilen veriler", word: "obtained", trWord: "elde edilen", blank: "The data ___ from the experiments" },
    { en: "The substance added to the liquid", tr: "Sıvıya eklenen madde", word: "added", trWord: "eklenen", blank: "The substance ___ to the liquid" },
    { en: "The plan adopted at the meeting", tr: "Toplantıda kabul edilen plan", word: "adopted", trWord: "kabul edilen", blank: "The plan ___ at the meeting" },
    { en: "The amount estimated by the analyst", tr: "Analist tarafından tahmin edilen miktar", word: "estimated", trWord: "tahmin edilen", blank: "The amount ___ by the analyst" },
    { en: "The method applied in the study", tr: "Çalışmada uygulanan yöntem", word: "applied", trWord: "uygulanan", blank: "The method ___ in the study" },
    { en: "The law abolished by the parliament", tr: "Meclis tarafından kaldırılan yasa", word: "abolished", trWord: "kaldırılan", blank: "The law ___ by the parliament" },
    { en: "The cost measured by the team", tr: "Ekip tarafından ölçülen maliyet", word: "measured", trWord: "ölçülen", blank: "The cost ___ by the team" },
    { en: "The changes approved by the committee", tr: "Komite tarafından onaylanan değişiklikler", word: "approved", trWord: "onaylanan", blank: "The changes ___ by the committee" }
  ]
};
...
const unit16LessonSentences = {
  1: [
    { en: "Understanding the problem is crucial", tr: "Problemi anlamak çok önemlidir", word: "Understanding", trWord: "anlamak", blank: "___ the problem is crucial" },
    { en: "Measuring the temperature requires precision", tr: "Sıcaklığı ölçmek hassasiyet gerektirir", word: "Measuring", trWord: "ölçmek", blank: "___ the temperature requires precision" },
    { en: "Changing the policy took many years", tr: "Politikayı değiştirmek uzun yıllar aldı", word: "Changing", trWord: "değiştirmek", blank: "___ the policy took many years" },
    { en: "Protecting the environment is our duty", tr: "Çevreyi korumak görevimizdir", word: "Protecting", trWord: "korumak", blank: "___ the environment is our duty" },
    { en: "Reducing the cost is the main goal", tr: "Maliyeti düşürmek temel hedeftir", word: "Reducing", trWord: "düşürmek", blank: "___ the cost is the main goal" },
    { en: "Operating this machine is dangerous", tr: "Bu makineyi çalıştırmak tehlikelidir", word: "Operating", trWord: "çalıştırmak", blank: "___ this machine is dangerous" },
    { en: "Evaluating the project is necessary", tr: "Projeyi değerlendirmek gereklidir", word: "Evaluating", trWord: "değerlendirmek", blank: "___ the project is necessary" },
    { en: "Controlling the process is difficult", tr: "Süreci kontrol etmek zordur", word: "Controlling", trWord: "kontrol etmek", blank: "___ the process is difficult" },
    { en: "Analyzing the data took three weeks", tr: "Verileri analiz etmek üç hafta sürdü", word: "Analyzing", trWord: "analiz etmek", blank: "___ the data took three weeks" },
    { en: "Heating the liquid produced gas", tr: "Sıvıyı ısıtmak gaz üretti", word: "Heating", trWord: "ısıtmak", blank: "___ the liquid produced gas" },
    { en: "Writing the summary helped the students", tr: "Özeti yazmak öğrencilere yardımcı oldu", word: "Writing", trWord: "yazmak", blank: "___ the summary helped the students" },
    { en: "Improving efficiency requires new methods", tr: "Verimliliği artırmak yeni yöntemler gerektirir", word: "Improving", trWord: "artırmak", blank: "___ efficiency requires new methods" },
    { en: "Preventing the pollution is essential", tr: "Kirliliği önlemek esastır", word: "Preventing", trWord: "önlemek", blank: "___ the pollution is essential" },
    { en: "Investigating the accident is important", tr: "Kazayı araştırmak önemlidir", word: "Investigating", trWord: "araştırmak", blank: "___ the accident is important" },
    { en: "Developing the software took six months", tr: "Yazılımı geliştirmek altı ay sürdü", word: "Developing", trWord: "geliştirmek", blank: "___ the software took six months" },
    { en: "Allocating the resources is difficult", tr: "Kaynakları tahsis etmek zordur", word: "Allocating", trWord: "tahsis etmek", blank: "___ the resources is difficult" }
  ]
};

const unit17LessonSentences = {
  1: [
    { en: "By measuring the temperature, we controlled the reaction", tr: "Sıcaklığı ölçerek tepkimeyi kontrol ettik", word: "measuring", trWord: "ölçerek", blank: "By ___ the temperature, we controlled the reaction" },
    { en: "On entering the laboratory, the researcher wore a coat", tr: "Laboratuvara girerken araştırmacı bir önlük giydi", word: "entering", trWord: "girerken", blank: "On ___ the laboratory, the researcher wore a coat" },
    { en: "In changing the policy, they faced many problems", tr: "Politikayı değiştirirken birçok sorunla karşılaştılar", word: "changing", trWord: "değiştirirken", blank: "In ___ the policy, they faced many problems" },
    { en: "Without protecting the forest, we cannot save the animals", tr: "Ormanı korumadan hayvanları kurtaramayız", word: "protecting", trWord: "korumadan", blank: "Without ___ the forest, we cannot save the animals" },
    { en: "By reducing the cost, the company increased its profit", tr: "Maliyeti düşürerek şirket kârını artırdı", word: "reducing", trWord: "düşürerek", blank: "By ___ the cost, the company increased its profit" },
    { en: "On reaching the surface, the water evaporated", tr: "Yüzeye ulaştığında su buharlaştı", word: "reaching", trWord: "ulaştığında", blank: "On ___ the surface, the water evaporated" },
    { en: "Without using the microscope, you cannot see the cells", tr: "Mikroskobu kullanmadan hücreleri göremezsiniz", word: "using", trWord: "kullanmadan", blank: "Without ___ the microscope, you cannot see the cells" },
    { en: "By modifying the design, the team improved the efficiency", tr: "Tasarımı değiştirerek ekip verimliliği artırdı", word: "modifying", trWord: "değiştirerek", blank: "By ___ the design, the team improved the efficiency" },
    { en: "In evaluating the project, the expert made some suggestions", tr: "Projeyi değerlendirirken uzman bazı önerilerde bulundu", word: "evaluating", trWord: "değerlendirirken", blank: "In ___ the project, the expert made some suggestions" },
    { en: "Without controlling the temperature, the reaction fails", tr: "Sıcaklığı kontrol etmeden tepkime başarısız olur", word: "controlling", trWord: "kontrol etmeden", blank: "Without ___ the temperature, the reaction fails" },
    { en: "By reading the book, the student understood the theory", tr: "Kitabı okuyarak öğrenci teoriyi anladı", word: "reading", trWord: "okuyarak", blank: "By ___ the book, the student understood the theory" },
    { en: "On receiving the data, the computer started the analysis", tr: "Verileri aldığında bilgisayar analize başladı", word: "receiving", trWord: "aldığında", blank: "On ___ the data, the computer started the analysis" },
    { en: "Without solving the problem, we cannot proceed", tr: "Problemi çözmeden ilerleyemeyiz", word: "solving", trWord: "çözmeden", blank: "Without ___ the problem, we cannot proceed" },
    { en: "By establishing the factory, they created new jobs", tr: "Fabrikayı kurarak yeni işler yarattılar", word: "establishing", trWord: "kurarak", blank: "By ___ the factory, they created new jobs" },
    { en: "In calculating the cost, they forgot the taxes", tr: "Maliyeti hesaplarken vergileri unuttular", word: "calculating", trWord: "hesaplarken", blank: "In ___ the cost, they forgot the taxes" },
    { en: "Without changing the law, they cannot stop the pollution", tr: "Yasayı değiştirmeden kirliliği durduramazlar", word: "changing", trWord: "değiştirmeden", blank: "Without ___ the law, they cannot stop the pollution" }
  ],
  2: [
    { en: "Before starting the experiment, read the instructions", tr: "Deneye başlamadan önce talimatları okuyun", word: "starting", trWord: "başlamadan", blank: "Before ___ the experiment, read the instructions" },
    { en: "After changing the plan, they informed the committee", tr: "Planı değiştirdikten sonra komiteye haber verdiler", word: "changing", trWord: "değiştirdikten", blank: "After ___ the plan, they informed the committee" },
    { en: "While measuring the temperature, the worker noticed a change", tr: "Sıcaklığı ölçerken işçi bir değişiklik fark etti", word: "measuring", trWord: "ölçerken", blank: "While ___ the temperature, the worker noticed a change" },
    { en: "Since leaving the university, he has worked at the clinic", tr: "Üniversiteden ayrıldığından beri klinikte çalışıyor", word: "leaving", trWord: "ayrıldığından", blank: "Since ___ the university, he has worked at the clinic" },
    { en: "When heating the liquid, use a glass tube", tr: "Sıvıyı ısıtırken cam tüp kullanın", word: "heating", trWord: "ısıtırken", blank: "When ___ the liquid, use a glass tube" },
    { en: "Before writing the summary, review your notes", tr: "Özeti yazmadan önce notlarınızı gözden geçirin", word: "writing", trWord: "yazmadan", blank: "Before ___ the summary, review your notes" },
    { en: "After observing the reaction, they wrote a report", tr: "Tepkimeyi gözlemledikten sonra bir rapor yazdılar", word: "observing", trWord: "gözlemledikten", blank: "After ___ the reaction, they wrote a report" },
    { en: "While operating the machine, wear safety glasses", tr: "Makineyi çalıştırırken koruyucu gözlük takın", word: "operating", trWord: "çalıştırırken", blank: "While ___ the machine, wear safety glasses" },
    { en: "Since adopting the new method, they have saved money", tr: "Yeni yöntemi benimsediklerinden beri tasarruf ettiler", word: "adopting", trWord: "benimsediklerinden", blank: "Since ___ the new method, they have saved money" },
    { en: "When analyzing the data, double-check the figures", tr: "Verileri analiz ederken rakamları tekrar kontrol edin", word: "analyzing", trWord: "analiz ederken", blank: "When ___ the data, double-check the figures" },
    { en: "Before changing the policy, they consulted the experts", tr: "Politikayı değiştirmeden önce uzmanlara danıştılar", word: "changing", trWord: "değiştirmeden", blank: "Before ___ the policy, they consulted the experts" },
    { en: "After evaluating the project, the committee approved the budget", tr: "Projeyi değerlendirdikten sonra komite bütçeyi onayladı", word: "evaluating", trWord: "değerlendirdikten", blank: "After ___ the project, the committee approved the budget" },
    { en: "While protecting the environment, they also created jobs", tr: "Çevreyi korurken aynı zamanda iş alanları yarattılar", word: "protecting", trWord: "korurken", blank: "While ___ the environment, they also created jobs" },
    { en: "Since reducing the waste, the factory has complied with the law", tr: "Atığı azalttığından beri fabrika yasaya uyuyor", word: "reducing", trWord: "azalttığından", blank: "Since ___ the waste, the factory has complied with the law" },
    { en: "When using the software, report any errors immediately", tr: "Yazılımı kullanırken hataları derhal bildirin", word: "using", trWord: "kullanırken", blank: "When ___ the software, report any errors immediately" },
    { en: "After solving the problem, they celebrated their success", tr: "Sorunu çözdükten sonra başarılarını kutladılar", word: "solving", trWord: "çözdükten", blank: "After ___ the problem, they celebrated their success" }
  ],
  3: [
    { en: "When heated, the liquid expands", tr: "Isıtıldığında sıvı genleşir", word: "heated", trWord: "Isıtıldığında", blank: "When ___, the liquid expands" },
    { en: "If asked, the researcher will explain the method", tr: "Sorulursa araştırmacı yöntemi açıklayacaktır", word: "asked", trWord: "Sorulursa", blank: "If ___, the researcher will explain the method" },
    { en: "Unless modified, the design is useless", tr: "Değiştirilmedikçe tasarım işe yaramaz", word: "modified", trWord: "Değiştirilmedikçe", blank: "Unless ___, the design is useless" },
    { en: "Although completed, the project is not yet active", tr: "Tamamlanmış olmasına rağmen proje henüz aktif değil", word: "completed", trWord: "Tamamlanmış", blank: "Although ___, the project is not yet active" },
    { en: "Until solved, the problem remains critical", tr: "Çözülene kadar sorun kritik kalmaya devam eder", word: "solved", trWord: "Çözülene", blank: "Until ___, the problem remains critical" },
    { en: "As described, the reaction takes place in a tube", tr: "Tanımlandığı gibi tepkime bir tüpte gerçekleşir", word: "described", trWord: "Tanımlandığı", blank: "As ___, the reaction takes place in a tube" },
    { en: "Where indicated, enter your password", tr: "Belirtilen yerde şifrenizi girin", word: "indicated", trWord: "Belirtilen", blank: "Where ___, enter your password" },
    { en: "When analysed, the data showed a new trend", tr: "Analiz edildiğinde veriler yeni bir eğilim gösterdi", word: "analysed", trWord: "Analiz edildiğinde", blank: "When ___, the data showed a new trend" },
    { en: "If approved, the plan will start next month", tr: "Onaylanırsa plan gelecek ay başlayacak", word: "approved", trWord: "Onaylanırsa", blank: "If ___, the plan will start next month" },
    { en: "Unless treated, the disease spreads quickly", tr: "Tedavi edilmezse hastalık hızlı yayılır", word: "treated", trWord: "Tedavi edilmezse", blank: "Unless ___, the disease spreads quickly" },
    { en: "Although damaged, the structure did not collapse", tr: "Hasar görmüş olmasına rağmen yapı çökmedi", word: "damaged", trWord: "Hasar görmüş", blank: "Although ___, the structure did not collapse" },
    { en: "Until verified, the results cannot be published", tr: "Doğrulanana kadar sonuçlar yayınlanamaz", word: "verified", trWord: "Doğrulanana", blank: "Until ___, the results cannot be published" },
    { en: "As expected, the cost increased by ten percent", tr: "Beklendiği gibi maliyet yüzde on arttı", word: "expected", trWord: "Beklendiği", blank: "As ___, the cost increased by ten percent" },
    { en: "Where allowed, parking is free", tr: "İzin verilen yerlerde park etmek ücretsizdir", word: "allowed", trWord: "İzin verilen", blank: "Where ___, parking is free" },
    { en: "When dissolved, the substance turns blue", tr: "Çözündüğünde madde maviye döner", word: "dissolved", trWord: "Çözündüğünde", blank: "When ___, the substance turns blue" },
    { en: "If requested, we will provide additional info", tr: "Talep edilirse ek bilgi sağlayacağız", word: "requested", trWord: "Talep edilirse", blank: "If ___, we will provide additional info" }
  ]
};
...
const rawTopics = [
  ...
  },
  {
    ...
    numLessons: 3,
    formulas: [
      { formula: "Preposition (on/by/in/without) + V-ing + Object", example: "By measuring the temperature, we controlled the reaction: Sıcaklığı ölçerek tepkimeyi kontrol ettik" },
      { formula: "Conjunction (when/while/before/after/since) + V-ing + Object", example: "Before starting the experiment, read the instructions: Deneye başlamadan önce talimatları okuyun" },
      { formula: "Conjunction (when/if/unless/although/until) + Past Participle (V3)", example: "When heated, the liquid expands: Isıtıldığında sıvı genleşir" }
    ],
    subtitles: [
...
const unitSentencesMap = {
  ...
  17: {
    1: unit17LessonSentences[1],
    2: unit17LessonSentences[2],
    3: unit17LessonSentences[3]
  },
  18: {
